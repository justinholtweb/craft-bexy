...
# Output: promos/out/bexy-promo-N.png at 1920x1080 (rendered at 2x, downsampled).
set -euo pipefail
...
for n in $SLIDES; do
  "$CHROME" \
    ...
    --screenshot="out/bexy-promo-$n.png" \
    "file://$PWD/slides.html?s=$n" >/dev/null 2>&1
  sips --resampleWidth 1920 "out/bexy-promo-$n.png" >/dev/null
  echo "  built out/bexy-promo-$n.png"
done
